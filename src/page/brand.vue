...
export default {
  ...
  metaInfo() {
    const title = '环球加盟网-让招商、投资变得简单!'
    return {
        title,
        meta: [{ vmid: 'keywords', name: 'keywords', content: "品牌加盟，品牌入驻，品牌服务" },
        { vmid: 'description', name: 'description', content: "专注于连锁加盟领域，月均保持17000次项目招商咨询服务，已有20万咨询注册用户，累计入驻7667 个品牌，联系电话：021-86157065，招商经理：+86  18106775771" }]
    }
  },
  methods: {
  }
